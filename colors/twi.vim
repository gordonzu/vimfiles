...
exe 'hi Normal         guifg='.s:text              .' guibg='.s:darkgrey        .' gui=italic'
...
exe 'hi Title          guifg='.s:light_grey_blue               .' guibg='.s:darkgrey        .' gui=none'
...
exe 'hi Identifier     guifg='.s:blue   .' guibg='.s:darkgrey        .' gui=italic,bold'
...
exe 'hi Function       guifg='.s:violet            .' guibg='.s:darkgrey        .' gui=italic,bold'
