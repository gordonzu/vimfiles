...
let colors_name = "termgitdark"

" {{{ General colors
hi Normal   ctermfg=185   ctermbg=0 cterm=bold  
...
hi StatusLine ctermfg=250 ctermbg=233 guifg=#404040 guibg=#bbbbbb gui=bold cterm=none
...
hi LineNr   ctermfg=238 ctermbg=0 guifg=#959595 guibg=#ECECEC gui=bold cterm=none
...
hi Identifier   ctermfg=33 cterm=bold guifg=#0086B3
hi PreProc  ctermfg=247 guifg=#A0A0A0 gui=bold cterm=bold
hi Comment  ctermfg=238 guifg=#999988
hi Constant ctermfg=33 guifg=#177F80 gui=none cterm=bold
hi String   ctermfg=130 guifg=#D81745
hi Function ctermfg=33 guifg=#990000 gui=bold cterm=bold
hi Statement    ctermfg=33 guifg=#000000 gui=bold cterm=bold
hi Type     ctermfg=33 guifg=#445588 gui=bold   cterm=bold
...
hi StorageClass ctermfg=33 guifg=#000000 gui=bold    cterm=bold
hi Structure    ctermfg=248 guifg=#000000 gui=bold    cterm=bold
hi TypeDef      ctermfg=248 guifg=#000000 gui=bold    cterm=bold
...
" {{{ Tabs
hi TabLine ctermfg=0 ctermbg=238 guifg=#404040 guibg=#dddddd gui=none
hi TabLineFill ctermfg=238 ctermbg=238 guifg=#404040 guibg=#dddddd gui=none
hi TabLineSel   ctermfg=245 guifg=#404040 gui=bold
" }}}
