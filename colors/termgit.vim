...
let colors_name = "termgit"

" {{{ General colors
"hi Normal   ctermfg=238   guifg=#000000   guibg=#F8F8FF
hi Normal   ctermfg=233   guifg=#000000   guibg=#F8F8FF
...
hi LineNr   ctermfg=244 guifg=#959595 guibg=#ECECEC gui=bold cterm=bold
...
hi Identifier   ctermfg=88 guifg=#0086B3 
"hi Identifier   ctermfg=88 guifg=#0086B3 cterm=bold
hi PreProc  ctermfg=28 guifg=#A0A0A0 gui=bold cterm=bold
hi Comment  ctermfg=246 guifg=#999988
hi Constant ctermfg=16 cterm=bold
"hi Constant ctermfg=88 cterm=bold
hi String   ctermfg=94 guifg=#D81745
hi Function ctermfg=16 guifg=#990000 gui=bold cterm=bold
...
hi Type     ctermfg=94 guifg=#445588 gui=bold   
"hi Type     ctermfg=24 guifg=#445588 gui=bold   cterm=bold
hi Number   ctermfg=28 guifg=#1C9898
...
hi keyword      ctermfg=88 cterm=bold
