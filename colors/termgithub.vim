...
hi LineNr   ctermfg=246 ctermbg=15 guifg=#959595 guibg=#ECECEC gui=bold cterm=none
...
hi Identifier   ctermfg=0 guifg=#0086B3
...
hi Statement    ctermfg=46 guifg=#000000 gui=bold cterm=bold

"hi Type     ctermfg=60 guifg=#445588 gui=bold   cterm=bold
hi Type     ctermfg=0 guifg=#445588 gui=bold   cterm=bold
