...
hi Title	guifg=#b17272 guibg=#101520 gui=bold
hi Visual	guibg=#000000 guifg=#cae682 gui=underline
hi VisualNOS	guifg=#b0b0b0 guibg=#101520

hi Number	guifg=#b17272 guibg=#101520
hi Char		guifg=#b17272 guibg=#101520
hi String	guifg=#b17272 guibg=#101520
hi Boolean	guifg=#b17272 guibg=#101520
hi Comment	guifg=#70c010
hi Constant 	guifg=#f0b040 guibg=#101520 gui=bold

" hi Identifier	guifg=#b17272
hi Identifier	guifg=#84c1ff gui=italic
hi Statement	guifg=#84c1ff gui=none

"Procedure name
hi Function	guifg=#f0f0f0 gui=italic

"Define, def
hi PreProc	guifg=#f0f0f0 gui=none

hi Type		guifg=#84c1ff gui=none
hi Underlined	guifg=#c0c0c0 gui=underline
hi Error	guifg=#b17272 guibg=#101520
"hi Error	guifg=#ee1111 guibg=#101520
hi Todo		guifg=#b17272 guibg=#101520 gui=none
...
if version >= 700
  ...
  hi TabLineSel	  guifg=#b17272 guibg=black gui=underline
endif
